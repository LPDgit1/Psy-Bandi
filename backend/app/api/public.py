...
# Keep the API compatibility names while sharing the lightweight query implementation
# with the static Streamlit catalog.
_build_contextual_facets = catalog_query.build_contextual_facets
_build_facets = catalog_query.build_facets
_detail = catalog_query.detail
_filter_items = catalog_query.filter_items
_list_item = catalog_query.list_item
_sort_items = catalog_query.sort_items
